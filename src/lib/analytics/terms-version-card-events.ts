/**
 * Terms Version Card analytics — COMPONENT-071.
 * Dev stub — slug and version only; no PII.
 */

import { TERMS_VERSION_CARD_ANALYTICS_SOURCE } from "@/config/terms-version-card";
...
function base(extra?: Props): Props {
  return {
    source: TERMS_VERSION_CARD_ANALYTICS_SOURCE,
    mock: true,
    ...extra,
  };
}

export const termsVersionCardAnalytics = {
